                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Analyze uploaded file</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form action="user_file_result.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <button class="btn btn-primary btn-icon-split mx-2" name="Submit" style="float: right;">
                                        ...
                                        <br>
                                        <label><strong>Please, upload files with .txt extension only</strong></label>
                                    </form>


                                    <!-- <div class="form-group">
                                        <label for="exampleFormControlTextarea1"><strong>Introduce a twitter link and run the sentiment analysis service</strong></label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                    </div>

                                    <button class="btn btn-primary btn-user float-right" name="Analyze">
                                        Analyze twitter link
                                    </button> -->
                            ...
                            <?php 
                                if(isset($_SESSION['wrong_extension']))
                                {
                            ?>
                            ...
                            <?php 
                                if(isset($_SESSION['wrong_dictionary_file']))
                                {
                            ?>
