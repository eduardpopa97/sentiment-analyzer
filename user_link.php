...
<head>
    ...
    <title>Analyze link content</title>
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Analyze a link</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form action="user_comments_result.php" method="POST">
                                        ...
                                        <input required type="text" name="link" class="form-control bg-light border-0 small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2">
                                        <div class="input-group-append">
                                            <button class="btn btn-primary btn-icon-split mx-2" name="Search" style="float: right;">
                                                <span class="icon text-white-50">
                                                    <i class="fas fa-search"></i>
                                                </span>
                                                <span class="text">Analyze link</span>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <?php 
                            if(isset($_SESSION['wrong_dictionary_link']))
                            {
                            ?>
